class Game
  ...
  def player_choice(player, symbol)
    ...
    #loop until the user unputs a valid coordinate - has a space between the two numbers, board slot is free
    until input.match(/\s/) && coord_one.between?(0, 2) && coord_two.between?(0, 2) && @board[coord_one][coord_two] == "_"
      puts "Please enter valid coordinates for an empty space in the board"

      input = gets.chomp
      input_array = input.split
      coord_one = input_arry[0].to_i
      coord_two = input_array[1].to_i
    end
...
#instructions
puts 'Welcome to tic-tac-toe. \nEach turn, enter two numbers with a space, per the grid layout below:'
puts "\r\n"
puts "0 0 | 0 1 | 0 2"
puts "1 0 | 1 1 | 1 2"
puts "2 0 | 2 1 | 2 2"
